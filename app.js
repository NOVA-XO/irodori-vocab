...
const THEMES = [
  ...
  { k: 'space', g: '宙', n: 'Сансар',
    ...
    c: ['#05070f', '#e7ecf7', '#8fb8ff'] },
  { k: 'mech', g: '機', n: 'Механик',
    d: 'Ган, сараалж · аюулгүйн улбар шар · хурц ирмэг',
    c: ['#14161a', '#dfe3e8', '#ff8c1a'] },
  { k: 'anime', g: '漫', n: 'Аниме',
    d: 'Манга хуудас · зузаан хар хүрээ · поп ягаан',
    c: ['#fffdf6', '#17171a', '#ff3d78'] },
  { k: 'elec', g: '電', n: 'Цахилгаан',
    d: 'Хэвлэмэл хэлхээ · гэрэлтэх фирүүз',
    c: ['#04070a', '#d8f5ee', '#35f0c0'] },
];
